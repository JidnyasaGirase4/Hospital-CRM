...
<template>
    <form class="card mx-auto max-w-5xl space-y-5 p-6 sm:p-8" @submit.prevent="submit">
        <h2 class="border-b border-slate-100 pb-4 text-xl font-extrabold tracking-tight text-slate-900">New Consultation</h2>
        ...
        <div>
            ...
            <input v-model="form.chief_complaint" class="input" />
        </div>
        <div>
        ...
        <div>
            ...
            <textarea v-model="form.examination" rows="2" class="input"></textarea>
        </div>
        <div>
        ...
        <div>
            ...
            <textarea v-model="form.clinical_notes" rows="2" class="input"></textarea>
        </div>
        <div>
        ...
        <div class="flex justify-end gap-3 border-t border-slate-100 pt-5">
            <RouterLink :to="{ name: 'consultations.index' }" class="btn btn-secondary">Cancel</RouterLink>
